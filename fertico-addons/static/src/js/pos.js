...
odoo.define('pos.custom', function (require) {
    "use strict";
    ...
    var NumpadWidget = PosBaseWidget.extend({
        ...
        applyAccessRights: function () {
            ...
            this.$el.find('.mode-button[data-mode="price"]')
                .toggleClass('disabled-mode', this.pos.config.restrict_price_control)
                .prop('disabled', this.pos.config.restrict_price_control);
